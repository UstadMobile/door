...
fun Trigger.toSql(entityKSClass: KSClassDeclaration, dbProductType: Int) : List<String>{
    val tableOrViewName = if(on == Trigger.On.ENTITY)
        entityKSClass.entityTableName
    else
        entityKSClass.replicationEntityReceiveViewName
